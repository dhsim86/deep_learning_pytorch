...
# (맥북 MPS 분기는 양자화를 못 쓰므로 아래 ①② 대신 가중치 전체가 16GB(bf16)로 올라갑니다)
#
# -----------------------------------------------------------------------------------------------------
...
#   풀 파인튜닝이었다면 이 두 항목만으로 8.03B x 12바이트 = 약 90 GiB 가 필요했을 겁니다.
...
#   즉 이 파일에서는 두 최적화가 "있으면 좋은 것"이 아니라 "없으면 안 돌아가는 것"입니다.
#
# -----------------------------------------------------------------------------------------------------
# D. 이 표를 읽을 때 주의할 점
# -----------------------------------------------------------------------------------------------------
...
#
#   이 실측은 같은 폴더의 kanana-2-1.3b 로 잰 값입니다. 구조가 같으므로 비율은 그대로 옮겨오지만,
